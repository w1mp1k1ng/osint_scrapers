...
OUTPUT_DIRECTORY="/mnt/projects/sources/spamhaus_drop/content"

TEMPOUTPUT=/tmp/${LABEL}.$$

OUTPUT="${LABEL}.${DATE}.content"

PAGE1="https://www.spamhaus.org/drop/drop.txt"

META1="spamhaus_drop_list_ip,suspect"
...
if [ -f ${TEMPOUTPUT} ]; then
  ...
  do
    ...
    MIN=`/mnt/projects/sources/spamhaus_drop/cidr-to-ip.sh ${CIDR} | /usr/bin/head -1`
    MAX=`/mnt/projects/sources/spamhaus_drop/cidr-to-ip.sh ${CIDR} | /usr/bin/tail -1`
